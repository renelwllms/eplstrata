  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-ink-700">Design reusable layouts for your invoices.</p>
      </div>
        ...
        <Card>
          <CardContent>
            <p className="text-sm text-ink-700">
              Invoice templates are not available on your current plan.
            </p>
          </CardContent>
        </Card>
      )}
        ...
        <Card>
          ...
          <CardContent>
            ...
            {templates.map((template) => (
              <a
                key={template.id}
                href={`/app/invoices/templates/${template.id}`}
